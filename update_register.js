                      ...
                      <View style={[styles.stepContainer, { justifyContent: 'flex-start' }]}>
                        ...
                        <View style={styles.sectorsContainer}>
                          <View style={styles.sectorsGrid}>
                            {['Tecnología', 'Salud', 'Finanzas', 'Construcción', 'Comercio', 'Supermercados', 'Restaurantes', 'Abogados', 'Educación', 'Otro'].map(sector => {
...
content = content.replace(/\{localRole === 'company' && \([\s\S]*?\}\)\}/, companyStepsBlock);
