    ...
    <>
      {companyStep === 1 && (
        <View style={[styles.stepContainer, { justifyContent: 'flex-start' }]}>
          ...
          <CustomInput placeholder="Correo institucional" value={email} onChangeText={setEmail} iconName="email-outline" role="company" />
        </View>
      )}
      ...
      {companyStep === 2 && (
        <View style={[styles.stepContainer, { justifyContent: 'flex-start' }]}>
          ...
          <CustomInput placeholder="Contraseña segura" value={password} onChangeText={setPassword} iconName="lock-outline" isPassword role="company" />
          ...
          <CustomInput placeholder="Confirmar contraseña" value={confirmPassword} onChangeText={setConfirmPassword} iconName="lock-check-outline" isPassword role="company" />
      ...
      {companyStep === 3 && (
        <View style={[styles.stepContainer, { justifyContent: 'flex-start' }]}>
          ...
          <CustomInput placeholder="Nombre de la empresa / Razón Social" value={companyName} onChangeText={setCompanyName} iconName="office-building" role="company" />
          ...
          <CustomInput placeholder="Sitio web (https://tuempresa.com)" value={companyWebsite} onChangeText={setCompanyWebsite} iconName="earth" role="company" />
          <SearchableSelect
          ...
          <SearchableSelect
            ...
            role="company"
          />
          <CustomInput placeholder="Teléfono de contacto" value={companyPhone} onChangeText={setCompanyPhone} iconName="phone-outline" role="company" />
        </View>
      )}
          ...
          <View style={styles.sectorsContainer}>
            ...
            {isOtherSector && (
              <View style={{ marginTop: 20 }}>
                 <CustomInput placeholder="Escribe tu sector" value={customSector} onChangeText={setCustomSector} iconName="pencil" role="company" />
              </View>
            )}
          </View>
        </View>
