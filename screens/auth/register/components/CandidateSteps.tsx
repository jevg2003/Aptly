    ...
    <>
      ...
      {candidateStep === 3 && (
        <View style={styles.stepContainer}>
          ...
          <Text style={styles.questionSubtitle}>
            Selecciona tu ubicación e ingresa tu información personal.
          </Text>
          ...
          <SearchableSelect
            ...
            options={
              selectedCountry ? COUNTRIES.find((c) => c.name === selectedCountry)?.cities || [] : []
            }
            iconName="city"
          ...
          <CustomInput
            placeholder={
              selectedCountry ? getNationalIdLabel(selectedCountry) : 'Selecciona tu país primero'
            }
            value={nationalId}
          ...
          <View style={{ alignItems: 'center', marginBottom: 10, marginTop: 15 }}>
            <TouchableOpacity
              ...
              style={[
                styles.avatarPicker,
                { borderColor: COLORS.candidate, backgroundColor: 'rgba(0,163,255,0.05)' },
              ]}>
              {avatarUrl ? (
        ...
        (() => {
          ...
          return (
            <View style={styles.stepContainer}>
              ...
              <Text style={styles.questionSubtitle}>
                Por favor ingresa tu fecha de nacimiento usando los selectores horizontales (Año,
                Mes, Día).
              </Text>
          ...
          {!profession ? (
            <View style={styles.professionSelectPrompt}>
              ...
              <Text style={styles.professionSelectPromptText}>
                Selecciona tu profesión arriba para certificar tu nivel con IA o elegirlo
                manualmente.
              </Text>
            </View>
          ) : (
                ...
                <View style={{ gap: 12 }}>
                  {['Junior', 'Mid-Level', 'Senior', 'Lead/Manager'].map((lvl) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.areaCard,
                        experienceLevel === lvl && styles.areaCardCandidateActive,
                      ]}
                      ...
                      <View
                        style={[
                          ...
                          {
                            borderColor:
                              experienceLevel === lvl ? COLORS.candidate : COLORS.textSecondary,
                          },
                        ]}>
                        {experienceLevel === lvl && (
                          <View
                            style={[styles.radioInner, { backgroundColor: COLORS.candidate }]}
                          />
                        )}
                      </View>
                      <Text
                        style={[
                          styles.areaText,
                          experienceLevel === lvl && { color: COLORS.candidate },
                        ]}>
                        {lvl}
                      </Text>
                    </TouchableOpacity>
                  ...
                  <View style={styles.aiPromoHeader}>
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Text style={styles.aiPromoSubtitle}>
                        Acredita tu experiencia en segundos
                      </Text>
                    </View>
                  </View>

                  <Text style={styles.aiPromoDesc}>
                    Resuelve 3 preguntas técnicas y de escenarios clave personalizadas para{' '}
                    <Text style={{ fontWeight: 'bold', color: '#FFF' }}>{profession}</Text> para
                    obtener tu certificado de competencias neón visible para reclutadores.
                  </Text>
      ...
      {candidateStep === 6 && (
        <View style={styles.stepContainer}>
          ...
          <Text style={styles.questionSubtitle}>
            Selecciona las industrias en las que te gustaría trabajar. Los sectores se sincronizan
            globalmente.
          </Text>
                ...
                return (
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      if (sector === 'Otro') {
                        if (isSelected)
                          setCandidateSectors((prev) => prev.filter((s) => s !== 'Otro'));
                        else setCandidateSectors((prev) => [...prev, 'Otro']);
                      } else {
                        if (isSelected)
                          setCandidateSectors((prev) => prev.filter((s) => s !== sector));
      ...
      {candidateStep === 7 && (
        <View style={[styles.stepContainer, { justifyContent: 'flex-start' }]}>
          ...
          <Text style={styles.questionSubtitle}>
            Selecciona habilidades de las categorías o añade las tuyas. Se sincronizarán
            automáticamente.
          </Text>
                      ...
                      return (
                        <TouchableOpacity
                          ...
                          style={[
                            ...
                            category === 'Recomendadas por IA' &&
                              isSelected && { borderColor: COLORS.candidate },
                          ]}
                          onPress={() => {
                            if (isSelected)
                              setCustomCandidateTags((prev) => prev.filter((t) => t !== tag));
                            else setCustomCandidateTags((prev) => [...prev, tag]);
                          }}>
                          <Text
                            style={[
                              styles.sectorTagText,
                              isSelected && styles.sectorTagTextActive,
                            ]}>
          ...
          <View
            ...
            <Text style={styles.sectorsLabel}>
              ¿Habilidad personalizada? Agrégala para uso común:
            </Text>
      ...
      {candidateStep === 8 && (
        <View style={[styles.stepContainer, { justifyContent: 'flex-start' }]}>
          ...
          <Text style={styles.questionSubtitle}>
            El número celular es obligatorio para que las empresas puedan contactarte.
          </Text>
      ...
      {candidateStep === 9 && (
        <View style={[styles.stepContainer, { justifyContent: 'flex-start' }]}>
          ...
          <Text style={styles.questionSubtitle}>
            Así se verá tu perfil principal para las empresas.
          </Text>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16 }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ color: COLORS.textSecondary }} numberOfLines={1}>
                  {profession || 'Profesión'} • {experienceLevel || 'Nivel'}
                </Text>
              </View>
            </View>
          ...
          <Text style={[styles.questionSubtitle, { marginTop: 24, marginBottom: 12 }]}>
            Añadir Currículum (Opcional)
          </Text>
          <TouchableOpacity
            style={[styles.pdfButton, { borderColor: pdfName ? COLORS.candidate : COLORS.border }]}
            onPress={pickDocument}>
            <MaterialCommunityIcons
              name={pdfName ? 'file-pdf-box' : 'file-upload-outline'}
              size={24}
              color={pdfName ? COLORS.candidate : COLORS.textSecondary}
            />
        ...
        <View style={[styles.stepContainer, { justifyContent: 'center', alignItems: 'center' }]}>
          ...
          <View
            ...
            <Text style={{ color: '#FFF', textAlign: 'center', lineHeight: 22 }}>
              Al finalizar, se enviará un correo de confirmación y podrás empezar a buscar vacantes
              que coincidan con tu perfil acreditado por la IA.
            </Text>
          </View>
        </View>
      )}
