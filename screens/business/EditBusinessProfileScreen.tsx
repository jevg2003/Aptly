...
export const EditBusinessProfileScreen = ({ navigation }: any) => {
  ...
  const SectionHeader = ({ icon, title }: any) => (
    <View className="mb-4 mt-8 flex-row items-center px-2">
      <View className="mr-3 h-10 w-10 items-center justify-center rounded-xl border border-[#333] bg-[#1A1A1C]">
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#050505' }}>
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        {/* Navigation Header */}
        <View className="flex-row items-center justify-between border-b border-[#1A1A1C] px-6 py-4">
          <TouchableOpacity onPress={() => navigation.goBack()}>
            <Ionicons name="arrow-back" size={24} color="white" />
          </TouchableOpacity>
          <Text className="text-lg font-bold text-white">Editar Perfil</Text>
          <TouchableOpacity onPress={handleSave} disabled={loading}>
            <Text className={`text-base font-bold text-[#FF005C] ${loading ? 'opacity-50' : ''}`}>
              {loading ? '...' : 'Guardar'}
            </Text>
          </TouchableOpacity>
        </View>
          ...
          <ScrollView
            ...
            <View style={{ marginTop: 24, alignItems: 'center' }}>
              <View
                ...
                <Text style={{ color: '#475569', fontStyle: 'italic', fontSize: 20 }}>
              ...
              <Text style={{ color: '#FFF', fontSize: 22, fontWeight: '900', marginTop: 16 }}>
                {name || 'Sin Nombre'}
              </Text>
              <View
                style={{
            ...
            {allTags.length > 0 ? (
              ...
              <Text style={{ color: '#475569', fontSize: 13, marginBottom: 12, marginLeft: 4 }}>
                No has seleccionado etiquetas aún.
              </Text>
            )}
            ...
            <TouchableOpacity
              ...
              <Text style={{ color: '#FF005C', fontWeight: '800', fontSize: 14 }}>
              ...
              {uploadingDocument ? (
                ...
                <>
                  ...
                  <Text style={{ color: '#94a3b8', fontSize: 11, marginTop: 4 }}>
                    Sube la presentación o portafolio de tu empresa
                  </Text>
                </>
              )}
            </TouchableOpacity>
        ...
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'flex-end' }}>
          <View
            ...
            <ScrollView
                    ...
                    {tags.map((tag) => {
                      ...
                      return (
                        <TouchableOpacity
                          ...
                          <Text
                            style={{
                              color: isSelected ? '#FF005C' : '#94a3b8',
                              fontWeight: '700',
                              fontSize: 13,
                            }}>
                            {tag}
              ...
              {/* Custom tag input */}
              <View
                style={{ borderTopWidth: 1, borderColor: '#1e1e1e', paddingTop: 20, marginTop: 4 }}>
                <Text
                  style={{
                    color: '#94a3b8',
                    fontSize: 11,
                  ...
                  <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 12 }}>
                    {customTags.map((tag) => (
                      <TouchableOpacity
                        ...
                        <Text style={{ color: '#FF005C', fontWeight: '700', fontSize: 12 }}>
                          {tag}
                        </Text>
            ...
            <View
              ...
              <Text
                style={{ color: '#475569', fontSize: 12, textAlign: 'center', marginBottom: 12 }}>
                {allTags.length} etiqueta{allTags.length !== 1 ? 's' : ''} seleccionada
                {allTags.length !== 1 ? 's' : ''}
              </Text>
              <TouchableOpacity
                onPress={() => setShowTagModal(false)}
